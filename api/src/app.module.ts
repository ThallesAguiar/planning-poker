...
import { RoomStudioService } from './ai/room-studio.service.js';
import { RoomStudioController } from './ai/room-studio.controller.js';
...
@Module({
  ...
  controllers: [AppController, AuthController, RoomController, ReportController, StudioController, RoomStudioController],
  providers: [AppService, PrismaService, AuthService, RoomService, RoomGateway, AuthorizationService, SessionService, TimerService, ReportService, AchievementsService, InsightsService, PdfExportService, LlmClient, AiParticipantService, RoomStateService, RoundService, PresenceService, CorrelationLogger, StudioService, RoomStudioService],
})
