...
import { useSelf } from '../../services/room-actions';
  ...
  return (
    <main className="app-shell">
      <StatusBar
        ...
        onOpenStudio={() => {
          if (isPO && state?.code) navigate(`/rooms/${encodeURIComponent(state.code)}/studio`);
        }}
      />
          ...
          <div className="rules">
            ...
            {isPO && (
              <div className="config-actions-row">
                ...
                <button type="button" className="config-open-link" onClick={() => state?.code && navigate(`/rooms/${encodeURIComponent(state.code)}/studio`)}>
